...
import { sincronizarMetricasMeta } from "@/lib/meta-ads-metrics-sync";
...
export async function POST(req: NextRequest) {
  ...
  const resultado = await sincronizarMetricasMeta(from, to);
  console.log("[CRON] meta-metrics:", resultado);
