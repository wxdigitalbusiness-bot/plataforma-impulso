...
export async function PATCH(req: NextRequest, { params }: Ctx) {
  ...
  const { nome, descricao, cor, status, cliente_id, visivel_portal } = body as {
    nome?: string; descricao?: string; cor?: string; status?: string; cliente_id?: number | null; visivel_portal?: boolean;
  };
